...
function normalizeQuoteRow(row = {}) {
  ...
  return {
    ...
    prices_include_vat: normalizeBoolean(row.prices_include_vat),
...
function normalizeQuotePayload(payload = {}) {
  ...
  return pickColumns({
    ...
    prices_include_vat: payload.prices_include_vat === undefined ? false : Boolean(payload.prices_include_vat),
